use std::{fmt, iter::{Product, Sum}, ops::{Add, AddAssign, Div, DivAssign, Index, IndexMut, Mul, MulAssign, Neg, Rem, RemAssign, Sub, SubAssign}};
...
impl Vec2 {
    ...
    pub const fn splat(v: f32) -> Self {
        Self { x: OrderedFloat(v), y: OrderedFloat(v) }
    }
    ...
    where
        F: Fn(f32) -> f32,
    {
        Self::new(f(self.x.0), f(self.y.0))
    }
    ...
    pub fn clamp(self, min: Self, max: Self) -> Self {
        //! // glam_assert!(min.cmple(max).all(), "clamp: expected min <= max"); - too lazy to fix now
    ...
    pub fn abs(self) -> Self {
        Self {
            x: OrderedFloat(f32::abs(self.x.0)),
            y: OrderedFloat(f32::abs(self.y.0)),
        }
    }
    ...
    pub fn signum(self) -> Self {
        Self {
            x: OrderedFloat(f32::signum(self.x.0)),
            y: OrderedFloat(f32::signum(self.y.0)),
        }
    }
    ...
    pub fn copysign(self, rhs: Self) -> Self {
        Self {
            x: OrderedFloat(f32::copysign(self.x.0, rhs.x.0)),
            y: OrderedFloat(f32::copysign(self.y.0, rhs.y.0)),
        }
    }
    ...
    pub fn div_euclid(self, rhs: Self) -> Self {
        Self::new(
            f32::div_euclid(self.x.0, rhs.x.0),
            f32::div_euclid(self.y.0, rhs.y.0),
        )
    }
    ...
    pub fn rem_euclid(self, rhs: Self) -> Self {
        Self::new(
            f32::rem_euclid(self.x.0, rhs.x.0),
            f32::rem_euclid(self.y.0, rhs.y.0),
        )
    }
    ...
    pub fn round(self) -> Self {
        Self {
            x: OrderedFloat(f32::round(self.x.0)),
            y: OrderedFloat(f32::round(self.y.0)),
        }
    }
    ...
    pub fn floor(self) -> Self {
        Self {
            x: OrderedFloat(f32::floor(self.x.0)),
            y: OrderedFloat(f32::floor(self.y.0)),
        }
    }
    ...
    pub fn ceil(self) -> Self {
        Self {
            x: OrderedFloat(f32::ceil(self.x.0)),
            y: OrderedFloat(f32::ceil(self.y.0)),
        }
    }
    ...
    pub fn trunc(self) -> Self {
        Self {
            x: OrderedFloat(f32::trunc(self.x.0)),
            y: OrderedFloat(f32::trunc(self.y.0)),
        }
    }
    ...
    pub fn exp(self) -> Self {
        Self::new(f32::exp(self.x.0), f32::exp(self.y.0))
    }
    ...
    pub fn powf(self, n: f32) -> Self {
        Self::new(f32::powf(self.x.0, n), f32::powf(self.y.0, n))
    }
    ...
    pub fn recip(self) -> Self {
        Self {
            x: OrderedFloat(1.0) / self.x,
            y: OrderedFloat(1.0) / self.y,
        }
    }
    ...
    pub fn mul_add(self, a: Self, b: Self) -> Self {
        Self::new(
            f32::mul_add(self.x.0, a.x.0, b.x.0),
            f32::mul_add(self.y.0, a.y.0, b.y.0),
        )
    }
    ...
    pub fn refract(self, normal: Self, eta: f32) -> Self {
        ...
        if k >= 0.0 {
            eta * self - (eta * n_dot_i + f32::sqrt(k)) * normal
        } else {
            Self::ZERO
        }
    }
    ...
    pub fn angle_to(self, rhs: Self) -> f32 {
        let angle = acos_approx_f32(
            self.dot(rhs) / f32::sqrt(self.length_squared() * rhs.length_squared()),
        );
    ...
    pub fn as_dvec2(&self) -> glam::DVec2 {
        glam::DVec2::new(self.x.0 as f64, self.y.0 as f64)
    }
    ...
    pub fn as_i16vec2(&self) -> glam::I16Vec2 {
        glam::I16Vec2::new(self.x.0 as i16, self.y.0 as i16)
    }
    ...
    pub fn as_u16vec2(&self) -> glam::U16Vec2 {
        glam::U16Vec2::new(self.x.0 as u16, self.y.0 as u16)
    }
    ...
    pub fn as_ivec2(&self) -> glam::IVec2 {
        glam::IVec2::new(self.x.0 as i32, self.y.0 as i32)
    }
    ...
    pub fn as_uvec2(&self) -> glam::UVec2 {
        glam::UVec2::new(self.x.0 as u32, self.y.0 as u32)
    }
    ...
    pub fn as_i64vec2(&self) -> glam::I64Vec2 {
        glam::I64Vec2::new(self.x.0 as i64, self.y.0 as i64)
    }
    ...
    pub fn as_u64vec2(&self) -> glam::U64Vec2 {
        glam::U64Vec2::new(self.x.0 as u64, self.y.0 as u64)
    }
...
impl core::ops::Div<Vec2> for Vec2 {
    type Output = Self;
    #[inline]
...
impl Div<Vec2> for f32 {
    ...
    fn div(self, rhs: Vec2) -> Vec2 {
        Vec2 {
            x: OrderedFloat(self.div(rhs.x.0)),
            y: OrderedFloat(self.div(rhs.y.0)),
        }
    }
}
...
impl Mul<Vec2> for f32 {
    ...
    fn mul(self, rhs: Vec2) -> Vec2 {
        Vec2 {
            x: OrderedFloat(self.mul(rhs.x.0)),
            y: OrderedFloat(self.mul(rhs.y.0)),
        }
    }
}
...
impl Add<Vec2> for f32 {
    ...
    fn add(self, rhs: Vec2) -> Vec2 {
        Vec2 {
            x: OrderedFloat(self.add(rhs.x.0)),
            y: OrderedFloat(self.add(rhs.y.0)),
        }
    }
}
...
impl Sub<Vec2> for f32 {
    ...
    fn sub(self, rhs: Vec2) -> Vec2 {
        Vec2 {
            x: OrderedFloat(self.sub(rhs.x.0)),
            y: OrderedFloat(self.sub(rhs.y.0)),
        }
    }
}
...
impl Rem<Vec2> for f32 {
    ...
    #[inline]
    fn rem(self, rhs: Vec2) -> Vec2 {
        Vec2::new(self.rem(rhs.x.0), self.rem(rhs.y.0))
    }
}
